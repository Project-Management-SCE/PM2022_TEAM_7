...
def-env activate-virtualenv [] {
    ...
    let virtual-env = 'C:\Users\liord\Documents\Django python project\Siteproject'
    let bin = 'Scripts'
    let path-sep = ';'
...
alias deactivate = source 'C:\Users\liord\Documents\Django python project\Siteproject\Scripts\deactivate.nu'
